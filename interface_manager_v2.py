        ...
        if cam_ not in active_cams:                                     # if camID is inactive initialize the camera
            ...
            while not restart_status:
                ...
                if read:
                    ...
                    if len(res) != 0:                   # if frames had any detection
                            ...
                            if cls == b'boat':
                                ...
                                #"""
                                    ...
                                    for contour in contours:
                                        ...
                                        #print(area)
                                        if area > 500:
                                            cv2.drawContours(image, contours, -1, (200,4,14), 2)
                    ...
                    if start_timer != 0:
                        if time.time() - start_timer > 120:    # check if timer is active for 120 sec or 2 mins
