...
for cam_ in cam:    # active_cameras:
    fender_image, minx, miny, maxx, maxy = fender_coordi(dir_of_file+'/ship/reference_files/fender_'+(cam_)+'.jpg')
    while True:
        read_frames_using_vlc(player=vlc_player_object[cam_],  delay_time=1,
